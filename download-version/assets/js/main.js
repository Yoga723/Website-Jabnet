(function ($) {
  ...
  */
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (subscriptionForm) {
      const overlayLoading = document.getElementById("form-overlay-loading");
      const overlaySuccess = document.getElementById("form-overlay-success");
      const overlayFailed = document.getElementById("form-overlay-failed");

      // Ambil semua tombol 'Close' dari overlay success dan failed
      const closeButtons = document.querySelectorAll("#form-overlay-success button, #form-overlay-failed button");

      // Fungsi untuk menyembunyikan semua overlay
      function hideAllOverlays() {
        overlayLoading.classList.add("d-none");
        overlaySuccess.classList.add("d-none");
        overlayFailed.classList.add("d-none");
      }
      ...
      subscriptionForm.addEventListener("submit", function (e) {
        ...
        fetch("https://jabnet.id/backend/email", {
          ...
          .catch((error) => {
            hideAllOverlays(); // Sembunyikan loading overlay
            // 5. Jika ada ERROR JARINGAN, tampilkan overlay failed
            overlayFailed.classList.remove("d-none");
